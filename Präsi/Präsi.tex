...
\begin{frame}{Beliefs and Human Capital Choices I}
    \begin{itemize}
        \item Until now: evidence that students hold beliefs that educational choices matter for career and family outcomes
...
\begin{frame}{Beliefs and Realized Outcomes III}
    ...
    \begin{tikzpicture}
        ...
        \draw<2>[red,ultra thick,rounded corners] (4.6, 3.9) rectangle (7.6, 4.4);
    \end{tikzpicture}
    \end{center}
\end{frame}
