...
- Discrete and finite time horizon: $t = 1, 2, ..., T$
  
- At each $t$, individuals decide types (or levels) of human capital investment: $k = 1, 2, ..., K$

- Outcomes are future earnings, labor supply, marriage, fertility
  
- an individual's expected utility is given by: $E_{i,\tau}(V_k) = \sum_{t=\tau + 1}^T \beta^{t-\tau} \int u_t(X) \; dG_{i,\tau}(X|k,t)$, <br> 
where $X$ is a vector of possible outcomes.

- $G_{i,\tau}(X|k,t)$ is the individual's __beliefs distributions__ about the probability of future outcomes $X$. $G$ have four characteristics:
  - reflect uncertainty
  - are heterogeneous
  - can be incorrect
  - evolve over time due to learning
...
- Surveyed students were in their freshman, sophomore or junior year; potential source of heterogeneity

- Given heterogeneity between gender in their selections of college majors.
...
- Gender differences in belief about labor supply at age 30, but not so much at age 45
  
- Generally male students belief that their labor supply (in terms of full-time work) will be higher over all education levels

-  For both male and female students, the belief is that full-time labor supply will be more probable when the have a degree vs. no degree, and for sci/business majors vs. humanities at age 30

-  At age 45 the differences are less pronounced, and only significant for females.

###    8.2 Labor Supply by Marital Status

- Males expectation to work full-time when married are significantly higher than females. Vice versa, females believe to be working part-time or not at all when being married.

- The gender differences are insignificant conditional on being single.

- For males, we there are no significant deviations in believes for full time work conditional on marital status, but women believe they are 18% less likely to work full-time

- For both genders, there is a positive relationship between being

## 9. Heterogeneity in Treatment Effects

###    9.1 Treatment Effects by Major

- Treatment: majoring in science/business

- Treatment effect on the treated: beliefs of students that do major in science/business

- Treatment effect on the untreated: beliefs of students that do not major in science/business

- Self earnings: business/science students expect a higher payoff of 0.66/0.56 from their majors than humanities students, which only expect 27/32 % higher earnings of the business/science majors. As it is still positive, it shows that humanities forgo payoffs on purpose.

- Students seem to select into majors in which they have a comparative advantage. Males that complete a sicence/business major perceive a 29% gain in relative rank, while women who major in humanities perceive a 50% loss were they to major in science/business.

- Consistent with the Roy model, students choose majors in which they have a comparative advantage.
  
###    9.2 Treatment Effects by School Year

- Little learning over the years is found except that freshman overestimate their ability (not in mean, but regarding the whole distribution)
  
## 10. Beliefs and Human Capital Choices

- Do beliefs drive educational choices? Specifically, not only earnings and ability, but also spousal earnings, marriage and fertility

- OLS for females: earnings and ability correlate positively with intended major; family variables are significant and reduce coefficient for earnings by 1/3

- OLS for males, family variables are insignificant and do not change the earnings coefficient

- These differences also hold for actual majors chosen in the follow-up: males took majors that they believed are positively correlated with earnings and not significant for family variables; vice versa for females.

- Females tend to incorporate family variables, including spousal earnings into consideration.
...
- What do students believe about the consequences of their education choices?

- How and for what reasons do students sort into majors?

- What roles do family variables play in student's choices?

- How good can students anticipate the consequences of their choices?
...
### 4. What are the main insights and policy implications?

- Family variables are significant for female students but not for males when choosing a major
...
- p. 10: Question about _distribution_ of outcomes. How is this implemented in a manner that provides consistent answers?
  
- Asking students about their earnings at age = 30, but the "outcome elicitation" takes place when they are only 25-27. Model about the increase in earnings, marriage etc.? Linear?

### 6. Propose a research design that would advance knowledge. 
